insert into deparment (name,description) values ('HR management','')
insert into deparment (name,description) values ('Administration','')
insert into deparment (name,description) values ('Service','')
insert into deparment (name,description) values ('Training','')
insert into deparment (name,description) values ('Internet security','')
insert into deparment (name,description) values ('Auditors','')
