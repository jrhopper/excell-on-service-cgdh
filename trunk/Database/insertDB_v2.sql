...
insert into action (name,link) values ('Manage Menu','Menu.aspx')
...
insert into serviceorderdetail (ServiceOrderId,EmpId,ServiceType,TaskName) values (0,0,1,'cong viec 5')
insert into serviceorderdetail (ServiceOrderId,EmpId,ServiceType,TaskName) values (0,0,2,'cong viec 8')
insert into serviceorderdetail (ServiceOrderId,EmpId,ServiceType,TaskName) values (1,3,1,'cong viec 7')
insert into serviceorderdetail (ServiceOrderId,EmpId,ServiceType,TaskName) values (1,3,0,'cong viec 15')
insert into serviceorderdetail (ServiceOrderId,EmpId,ServiceType,TaskName) values (1,3,1,'cong viec 18')
insert into serviceorderdetail (ServiceOrderId,EmpId,ServiceType,TaskName) values (1,3,2,'cong viec 17')
insert into serviceorderdetail (ServiceOrderId,EmpId,ServiceType,TaskName) values (2,2,1,'cong viec 14')
insert into serviceorderdetail (ServiceOrderId,EmpId,ServiceType,TaskName) values (2,2,1,'cong viec 19')
insert into serviceorderdetail (ServiceOrderId,EmpId,ServiceType,TaskName) values (3,1,0,'cong viec 13')
insert into serviceorderdetail (ServiceOrderId,EmpId,ServiceType,TaskName) values (3,1,1,'cong viec 12')
insert into serviceorderdetail (ServiceOrderId,EmpId,ServiceType,TaskName) values (3,1,0,'cong viec 11')
------------------------------------------------------------------------------------------------
