...
CREATE TABLE [DepartmentDetail] (
    ...
    [MenuId] INTEGER,
    [Description] NVARCHAR(200),
    CONSTRAINT [PK_DepartmentDetail] PRIMARY KEY ([Id])
)
GO
...
ALTER TABLE [DepartmentDetail] ADD CONSTRAINT [Department_DepartmentDetail] 
    FOREIGN KEY ([DepartmentId]) REFERENCES [Department] ([Id])
GO

ALTER TABLE [DepartmentDetail] ADD CONSTRAINT [Menu_DepartmentDetail] 
