...
<center>
    ...
    <p>
        <asp:Label ID="Label1" runat="server" Font-Bold="False" Font-Size="25pt" 
            ForeColor="#0066FF" Text="Management Service Order Detail"></asp:Label>
    </p>
    <br />
    <p>
    ...
    <asp:Button ID="btnCreate" OnClick="btnCreateNew_Click" runat="server" Text="Create New Service Order Detail" />
</center>
</asp:Content>
