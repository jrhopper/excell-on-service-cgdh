<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="UpdateAction.aspx.cs" Inherits="Admin_UpdateAction" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<center>
    <p>
        <asp:Label ID="Label1" runat="server" Font-Bold="False" Font-Size="25pt" 
            ForeColor="#0066FF" Text="Update Action"></asp:Label>
    </p><br />
</center>
<table style="margin-left:330px">
        ...
        <tr>
            <td colspan=2>
                ...
                <asp:Button ID="Button1" runat="server" CausesValidation=false Text="Action List" PostBackUrl="~/Admin/Action.aspx" />
