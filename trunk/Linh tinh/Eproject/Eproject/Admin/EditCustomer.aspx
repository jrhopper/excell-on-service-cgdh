<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditCustomer.aspx.cs" Inherits="Eproject.Admin.AddCustomer" %>
    ...
    <table style="width:100%;">
        ...
        <tr>
            ...
            <td align="right" class="style8">
                <asp:Button ID="btEdit" runat="server" style="margin-left: 0px" Text="Edit" 
                    Width="100px"/>
            </td>
            <td class="style11">
