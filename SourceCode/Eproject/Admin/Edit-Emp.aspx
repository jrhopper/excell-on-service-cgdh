<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Edit-Emp.aspx.cs" Inherits="Admin_Edit_Emp" %>
...
<table style="margin:0 auto; text-align:left" width="371" border="1" cellspacing="0" cellpadding="5">
  ...
  <tr>
    ...
    <td><input type="text" name="rcf_date" id="textfield3" /></td>
  </tr>
  <tr>
    <th scope="row">Sex</th>
