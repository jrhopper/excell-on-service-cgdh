...
public partial class Admin_FormCreateServiceOrderDetail : System.Web.UI.Page
{
    ...
    protected void btnCreate_Click(object sender, EventArgs e)
    {
        ...
        else if (serviceOrderDetailBLL.checkServiceOrderDetailNameByName(txtTaskname.Value) == 0)
        {
            ...
            {
                Response.Write("<script>alert('Create Service Order Detail Successful.');window.location='ManageServiceOrderDetail.aspx';</script>");
            }
            else
            {
                Response.Write("<script>alert('Create Service Order Detail Fail.');window.location='ManageServiceOrderDetail.aspx';</script>");
            }
        }
